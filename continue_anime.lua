...
local ani_cli_state_dir = os.getenv("HOME").."/.local/state/anime/"
local anime_eps_history_file_loc = ani_cli_state_dir.."anime_hsts/"
...
function AnimeEpTimestamp:GetProps()
  ...
  -- self.anime_ep_timestamp_file_path = ani_cli_state_dir.."anime_hsts/"..self.anime_name
...
-- mp.set_property("watch-later-directory", "/home/blank/.local/state/anime/watch_later_tmp/")
